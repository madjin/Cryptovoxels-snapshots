...
def get_contract_info(contract_address, verbose=False):
    verbose_print("Fetching contract info...", verbose)
    params = {
        "address": contract_address,
        "chain": "eth",
    }
...
def main(contract_address, output_file=None, verbose=False):
    ...
    contract_info = get_contract_info(contract_address, verbose)
    collection_info = {
        "Collection Name": contract_info['name'],
