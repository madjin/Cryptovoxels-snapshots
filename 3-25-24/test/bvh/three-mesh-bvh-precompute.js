...
//
const { Accessor, Extension, ExtensionProperty, NodeIO, PropertyType, ReaderContext, VertexLayout, WriterContext } = require('@gltf-transform/core');
const { PropertyGraph } = require('@gltf-transform/core/dist/properties');
const { KHRONOS_EXTENSIONS } = require('@gltf-transform/extensions');
const { join, normalize, resolve } = require('path');
const { Box3, BufferGeometry, Float32BufferAttribute } = require('three');
